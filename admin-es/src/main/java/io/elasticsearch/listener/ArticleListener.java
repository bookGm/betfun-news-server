...
public class ArticleListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(name = Constants.article_Save_Queue, durable = "true"),
            exchange = @Exchange(name = Constants.articleExchange, type = ExchangeTypes.TOPIC),
     ...
     */
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(name = Constants.article_Delete_Queue, durable = "true"),
            exchange = @Exchange(name = Constants.articleExchange, type = ExchangeTypes.TOPIC),
     ...
     */
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(name = Constants.article_Update_Queue, durable = "true"),
            exchange = @Exchange(name = Constants.articleExchange, type = ExchangeTypes.TOPIC),
