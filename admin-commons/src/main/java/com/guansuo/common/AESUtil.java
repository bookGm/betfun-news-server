...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "exj";
    ...
    public static String aesDecode(String content) {
        try {
            ...
            throw new RuntimeException("配置文件中的密码需要使用AES加密，请使用com.exj.common.utils.AESUtil工具类修改这些值！");
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
        //如果有错就返加nulll
    ...
    public static String exjConfigDecode(String value){
    	if(StringUtil.isNotBlank(value)&&value.startsWith("AES@")){
    		value=AESUtil.aesDecode(value.replaceFirst("AES@", ""));
    	}
    	return value;
    }
